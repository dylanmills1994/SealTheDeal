  ...
  return (
    <section className="relative overflow-hidden bg-background">
      <div className="mx-auto max-w-7xl"><div className="grid min-h-[600px] lg:grid-cols-2"><div className="flex flex-col justify-center px-4 py-12 lg:px-8 lg:py-16">
        ...
        <div className="flex flex-wrap gap-4"><Button size="lg" asChild><a href={DEFAULT_PHONE_HREF}><Phone className="mr-2 h-4 w-4" />Call {cms.text.phone_display}</a></Button><Button size="lg" variant="outline" type="button" onClick={() => window.dispatchEvent(new Event(CONTACT_MODAL_EVENT))}><Mail className="mr-2 h-4 w-4" />Request a Quote</Button></div>
