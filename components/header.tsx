...
export function Header() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const body = [`Name: ${formData.name}`, `Phone: ${formData.phone}`, `Email: ${formData.email}`, "", "Message:", formData.message].join("\n")
